// app/static/js/apartment_card_java.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateOptionUI(optionElement) {
        ...
        finalPriceSpan.textContent = formatCurrency(calculatedPrices.finalPrice) + ' KZT';
        if (initialPaymentSpan) {
            if (calculatedPrices.initialPayment !== null && calculatedPrices.initialPayment >= 0) {
                initialPaymentSpan.textContent = formatCurrency(calculatedPrices.initialPayment) + ' KZT';
            } else {
                initialPaymentSpan.textContent = '— KZT';
            }
        }
