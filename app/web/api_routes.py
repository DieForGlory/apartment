...
api = Api(
    api_bp,
    version='1.0',
    title='Система аналитики и рассчётов',
    description='API для мобильного приложения и внешних интеграций',
    doc='/docs/'
)

# ===================================================================
#          ПРОСТРАНСТВО ИМЕН ДЛЯ QualifiedА КВАРТИР
# ===================================================================
...
search_model = apartments_ns.model('ApartmentSearchInput', {
    ...
    'currency': fields.String(required=True, description='Валюта', enum=['USD', 'KZT'], example='USD'),
...
inventory_parser.add_argument('currency', type=str, default='KZT', choices=['KZT', 'USD'],
